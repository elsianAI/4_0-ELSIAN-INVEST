...
- **Tests:** `python3 -m pytest -q tests/unit/test_source_map.py tests/integration/test_source_map.py` → green. `python3 -m ruff check elsian/assemble/source_map.py elsian/cli.py tests/unit/test_source_map.py tests/integration/test_source_map.py` → clean. `git diff --check` → clean.
