...
- [x] Step 8: First Extractor (HtmlTableExtractor)
- [x] Step 9: First Fetcher (SecEdgarFetcher)
- [x] Step 10: Port all test cases (regression suite — 7/7 at 100%)
- [x] Step 11: Acquire layer (SecEdgarFetcher, EuRegulatorsFetcher, converters)
